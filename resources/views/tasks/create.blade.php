            ...
            <div class="space-y-4">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="notes" name="notes" class="mt-1 block w-full px-3 py-3 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="{{ old('notes') }}">
                        @error('notes')
                            <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
